...
const SAMPLE_RELEASES = [
  {
    ...
    name: "v0.8.1",
    tag_name: "v0.8.1",
    html_url: "https://github.com/example/memosync/releases/tag/v0.8.1",
  ...
  },
  {
    ...
    html_url: "https://github.com/example/memosync/releases/tag/v0.9.0-beta.1",
...
describe("ChangelogSection", () => {
  test("renders version highlights, release cards, markdown, links, and prerelease badges", () => {
    ...
    expect(html).toContain("https://github.com/example/memosync/releases/tag/v0.8.1")
