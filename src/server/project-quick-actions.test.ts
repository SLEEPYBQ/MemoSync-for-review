...
describe("project quick actions", () => {
  ...
  test("writes quick actions to the project .memosync directory", async () => {
    ...
    await expect(Bun.file(path.join(projectPath, ".memosync", "quick-actions.json")).exists()).resolves.toBe(true)
  })
})
